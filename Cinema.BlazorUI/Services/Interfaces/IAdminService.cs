...
public interface IAdminService
{
  ...
  Task<FormResult> UpdateSessionAsync(int sessionId, DateTime date, int hallNumber, int price);
  ...
  Task<FromattedSession> GetSessionAsync(int movieId, DateTime date, int hallNumber);
}
